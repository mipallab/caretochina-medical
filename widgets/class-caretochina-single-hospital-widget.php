...
class CareToChina_Single_Hospital_Widget extends Widget_Base {
    ...
    public function get_title() {
        return __('CareToChina Single Hospital Layout', 'caretochina-medical');
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Single Hospital Options', 'caretochina-medical'),
        ...
        $this->add_control(
            'show_quote_btn',
            [
                'label'        => __('Show Free Quote Button', 'caretochina-medical'),
        ...
        $this->add_control(
            ...
            [
                'label'        => __('Show CareToChina Concierge Sidebar', 'caretochina-medical'),
                'type'         => Controls_Manager::SWITCHER,
                'default'      => 'yes',
            ]
        );
        ...
        $this->add_control(
            'show_specialties',
            [
                'label'        => __('Show Specialities', 'caretochina-medical'),
                'type'         => Controls_Manager::SWITCHER,
                'default'      => 'yes',
            ]
        );
        ...
        $this->add_control(
            'show_departments',
            [
                'label'        => __('Show Departments', 'caretochina-medical'),
                'type'         => Controls_Manager::SWITCHER,
                'default'      => 'yes',
            ]
        );
        ...
        $this->add_control(
            'show_comments',
            [
                'label'        => __('Enable Comments / Patient Reviews', 'caretochina-medical'),
                'type'         => Controls_Manager::SWITCHER,
                'default'      => 'yes',
            ]
        );
    ...
    protected function render() {
        ...
        if (!$post) {
            echo '<p class="ctc-no-hospital">' . esc_html__('No hospital post found to render.', 'caretochina-medical') . '</p>';
            return;
        }

        $post_id       = $post->ID;
        $title         = get_the_title($post_id);
        $type          = get_post_meta($post_id, '_hospital_type', true) ?: __('JCI Accredited Multi-Specialty Hospital Center', 'caretochina-medical');
        $location      = get_post_meta($post_id, '_hospital_location', true) ?: 'Shanghai, China';
        $rating        = get_post_meta($post_id, '_hospital_rating', true) ?: '4.9 (1,240 Reviews)';
        $certification = get_post_meta($post_id, '_hospital_certification', true) ?: 'JCI Certified';
        $quote_url     = get_post_meta($post_id, '_hospital_quote_url', true) ?: '#booking';
        ...
        $show_sidebar  = $settings['show_concierge_sidebar'];
        ?>

        <div class="ctc-single-hosp-container ctc-elementor-widget-render">
                ...
                <div class="ctc-hero-header-content">
                    ...
                    <?php if ($settings['show_quote_btn'] === 'yes') : ?>
                        <div class="ctc-hero-cta-row">
                            <a href="<?php echo esc_attr($quote_url); ?>" class="ctc-quote-btn" aria-label="<?php esc_attr_e('Request Free Quote & Consultation', 'caretochina-medical'); ?>">
            ...
            <!-- Layout Grid -->
            <div class="ctc-hosp-layout-grid <?php echo ($show_sidebar !== 'yes') ? 'no-sidebar' : ''; ?>">
                ...
                <div class="ctc-hosp-main-col">
                    ...
                    <!-- Concierge Packages Comparison Grid -->
                    <?php if ($settings['show_packages'] === 'yes') : 
                    ...
                    ?>
                        <div class="ctc-hosp-card-box ctc-packages-box" id="widget-concierge-packages">
