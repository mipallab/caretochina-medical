...
class CareToChina_Hospitals_Plugin {
    ...
    public function save_hospital_metaboxes($post_id) {
        ...
        delete_post_meta($post_id, '_hospital_wechat_id');
        delete_post_meta($post_id, '_hospital_wechat_qr');
    ...
    public static function get_hospital_concierge_data($post_id) {
        ...
        $final_wechat_id = $settings['wechat_id'] ?? '';
        $final_wechat_qr = $settings['wechat_qr'] ?? '';
