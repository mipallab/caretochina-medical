            ...
            <div class="ctc-booking-modal-container">
                ...
                <div class="wizard-steps-indicator">
                    ...
                    <div class="wiz-step" data-step="3">
                        ...
                        <span class="wiz-step-label"><?php esc_html_e('Patient Details', 'caretochina-medical'); ?></span>
                    </div>
                </div>
                ...
                <form id="ctc-booking-wizard-form">
                    ...
                    <div class="wiz-page" id="wiz-step-2" style="display:none;">
                        <div class="form-group mb-16">
                            ...
                            <!-- Global Service Notes Accordion / Callout Box -->
                            <div class="wiz-service-notes-box">
                                <details>
                                    <summary>
                                        <i class="fa-solid fa-circle-info"></i> <?php esc_html_e('View Global Concierge Service Notes & Inclusions', 'caretochina-medical'); ?>
                                    </summary>
                                    <div class="wiz-service-notes-content">
    ...
    public function handle_booking_submission() {
        ...
        if ($existing_active && $package_id > 0) {
            ...
            wp_send_json_success([
                ...
                'already_active'  => true,
                'message'         => sprintf(__('You already have an active booking (#%1$s) for %2$s. Redirecting to your consultation desk...', 'caretochina-medical'), $existing_active->booking_code, $existing_active->specialty)
            ]);
        }
